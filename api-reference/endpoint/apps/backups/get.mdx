...
api: "GET https://api.dscloud.app/v2/apps/{app_id}/backups"
authMethod: "none"
---

<Warning>**Exclusive route for [Pro](https://dscloud.app/en/pay?plan=pro), [Business](https://dscloud.app/en/pay?plan=business), and [Enterprise](https://dscloud.app/en/pay?plan=enterprise) clients.**</Warning>
<ParamField header="Authorization" type="string" placeholder="API KEY" required>
  The API key for your account. You can find this in your [account settings](https://dscloud.app/dashboard/settings).
</ParamField>
...
<Note>The format of the URL to download the desired backup is: https://backups.dscloud.app/{accountID}_{name}.zip?{key}</Note>