...
api: "GET https://api.dscloud.app/v2/apps/{app_id}/network/dns"
authMethod: "none"
---

**Is necessary to have at least the [Standard plan](https://dscloud.app/plans) to use this route.**
