...
Our platform offers plans with up to **128GB of RAM**, but the **maximum allocation per individual application is 32GB**.
...
* **All projects:** Each project comes with a default allocation of **15GB** of storage.
...
If an application exceeds its allocated RAM limit, as defined in its [config file](../getting-started/config-file), it will be flagged for **LACK\_OF\_RAM** and automatically shut down to prevent system overload.
