---
title: "Client"
description: "The DSCloudAPI is the main interface for interacting with the DSCloud service. Instantiated with an API key, it provides access to various aspects of the service."
---
