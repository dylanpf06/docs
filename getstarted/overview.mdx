...
<Frame>
  <img src="https://cdn.dscloud.app/blog/posts/changelog/01-02-2024/ds-cli-install.gif" />
</Frame>
<br/>
...
<Steps>
  <Step title="Access the DS Cloud website">
    Access the [DS Cloud dashboard](https://dscloud.app/dashboard) using your account.
  </Step>
  <Step title="Create your DS Cloud config file">
...
If you have any questions or need help, you can reach out to our [support team](https://dscloud.app/dashboard/support). We're here to help you! 🚀
