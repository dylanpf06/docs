...
<Steps>
  ...
  <Step title="Create your DS Cloud config file.">
    After accessing the dashboard, create a configuration file. You can learn how to create a [configuration file](/getting-started/config-file) by reading this article [here](/getting-started/config-file).
