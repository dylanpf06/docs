...
<Card title="Bot Hosting" href="/services/bot">
...
<Card title="Database as a Service" href="/services/database">
...
<Steps>
  ...
  <Step title="Create your DS Cloud config file.">
    Create a configuration file for your project. You can learn how to create a [configuration file](/getstarted/configfile) by reading this article [here](/getstarted/configfile).
    ...
    ```systemd Example of a config file for a web application (URL configured to be "batman.dscloud.pt")
    MAIN=index.js
    MEMORY=512
    VERSION=recommended
    SUBDOMAIN=batman
