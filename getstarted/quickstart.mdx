...
<Steps>
  ...
  <Step title="ZIP your project.">
    ...
    <CodeGroup>
      ```bash Windows
      1. Right-click the file or folder, select "Send to," and choose "Compressed (zipped) folder."
      ```
      ```bash Linux
      1. Right-click the file or folder, then choose "Compress" from the menu.
      ```
      ```bash macOS
      1. Control-click the file or folder, then choose "Compress" from the menu.
      ```
    </CodeGroup>
   </Step>
