...
<Steps>
  ...
  <Step title="AUTORESTART" icon="rotate">
    ...
    <Info>By default, this parameter is set to `true`.</Info>
  </Step>
  ...
  <Step title="SUBDOMAIN" icon="globe">
    ...
    <Note>Website URL will be: mysite.dscloudweb.pt</Note>
  </Step>
...
<Info>Website URL will be: mysite.dscloudweb.pt</Info>
