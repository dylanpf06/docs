...
- Create an account on DS Cloud via the [login page](https://dscloud.pt/login.html.html) using your email, Discord, or both.
...
>
  ...
  <Accordion title="Bad Memory" icon="memory" iconType="solid">
    ...
    - Bots: 256MB
    - Websites/APIs: 512MB
    Depending on application size and complexity, allocate more RAM to avoid the [LACK_OF_RAM](https://docs.dscloud.pt/faqs/troubleshooting/LACK_OF_RAM) error.
  </Accordion>
</AccordionGroup>
