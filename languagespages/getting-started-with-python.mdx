...
- Before you begin, make sure you have Python on your system. If you don't have it, download it from the [official Python website](https://www.python.org/).
- Create an account on DS Cloud via the [login page](https://dscloud.app/login) using your email, Discord, or both.
- Ensure you have an active paid plan. View and purchase plans [here](https://dscloud.app/plans).
...
- [dscloud.app](/getting-started/config-file) (DS Cloud configuration file).
